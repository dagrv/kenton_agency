    ...
    return (
        <div ref={refContainer}
            ...
            <div className="p-12 font-bold z-10 text-center flex-1 flex items-center justify-center flex-col drop-shadow-[0_5px_3px_rgba(0,0,0,0.4)]">
                <h1 className="text-4xl mb-6 xl:text-5xl">Kenton Web Agency</h1>
                <h2 className='text-2xl mb-2 xl:text-3xl tracking-tight'>A group of young people, passionate by <span className="text-sky-600">Web</span> & <span className="text-red-500">Skate</span></h2>
            </div>
