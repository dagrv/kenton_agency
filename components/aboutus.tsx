    ...
    return <section className={`flex flex-col bg-white py-20 text-3xl md:text-4xl text-black`}>
        ...
        <div className="container mx-auto px-11 text-center mt-28">
            ...
            <div className="mt-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 lg:gap-20">
                <Member id="1" name="Person 1" socialId="@person1" link="https://github.com/1" />
                <Member id="1" name="Person 2" socialId="@person2" link="https://github.com/1" />
                <Member id="1" name="Person 3" socialId="@person3" link="https://github.com/1" />
                <Member id="1" name="Person 4" socialId="@person4" link="https://github.com/1" />
                <Member id="1" name="Person 5" socialId="@person5" link="https://github.com/1" />
            </div>
        </div>
    </section>
}
